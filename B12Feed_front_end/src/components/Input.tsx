    ...
    <div className="space-y-1.5 w-full text-left">
      ...
      <div className="relative">
        <input
          {...props}
          type={inputType}
          className={`w-full px-5 py-4 rounded-2xl bg-neutral-50 border outline-none transition-all ${
            error 
              ? "border-red-400 focus:ring-2 focus:ring-red-100" 
              : "border-neutral-200 focus:ring-2 focus:ring-[#058177]/20 focus:border-[#058177]"
          } ${isPassword ? "pr-12" : ""}`}
        />
